...
# User Input Section: the section containing code for user input is tests the genre prediction model
# by asking the user to enter the numerical feautures for a song, with some flexibility. The average
# value of a feature is used if the user is unsure. A website is recommend just for ease of accessing
# these features quickly for any song. 
